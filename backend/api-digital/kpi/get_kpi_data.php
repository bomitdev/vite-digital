...
try {
    ...
    if ($action == 'getAll') {
        ...
        $sql = "SELECT 
                    ...
                    k.kpi_periodicity, k.numerator_label, k.denominator_label, k.calculation_type, k.multiplier, k.responsible_person, k.responsible_unit, k.kpi_level, k.level_codes, k.analysis,
                    k.sql_query, k.db_connection,

...
try {
    ...
    if ($action == 'getAll') {
        ...
        $sql = "SELECT 
                    ...
                    k.kpi_periodicity, k.numerator_label, k.denominator_label, k.calculation_type, k.multiplier, k.responsible_person, k.responsible_unit, k.kpi_level, k.analysis,

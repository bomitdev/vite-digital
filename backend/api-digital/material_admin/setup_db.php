...
try {
    ...
    $query1 = "
    CREATE TABLE IF NOT EXISTS `mt_admin_materials` (
        `id` INT(11) NOT NULL AUTO_INCREMENT,
        `code` VARCHAR(50) NOT NULL COMMENT 'รหัสสินค้า',
        `name` VARCHAR(150) NOT NULL COMMENT 'ชื่ออุปกรณ์',
        `type` VARCHAR(100) NOT NULL COMMENT 'ประเภท',
        `unit` VARCHAR(50) NOT NULL COMMENT 'หน่วยนับ',
        `price_per_unit` DECIMAL(10,2) DEFAULT 0.00 COMMENT 'ราคาต่อหน่วย',
    ...
    $query2 = "
    CREATE TABLE IF NOT EXISTS `mt_admin_transactions` (
        `id` INT(11) NOT NULL AUTO_INCREMENT,
        ...
        `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
        PRIMARY KEY (`id`),
        FOREIGN KEY (`material_id`) REFERENCES mt_admin_materials(`id`) ON DELETE CASCADE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
    ";
    ...
    echo json_encode([
        'status' => 'success',
        'message' => 'Tables mt_admin_materials and mt_admin_transactions created successfully in digital DB.'
    ]);

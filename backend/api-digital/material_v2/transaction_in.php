...
try {
    ...
    $stmtMaterial = $pdo2->prepare("SELECT id, balance, price_per_unit FROM mt_materials WHERE id = :id FOR UPDATE");
    ...
    $stmtTx = $pdo2->prepare("
        INSERT INTO mt_transactions (material_id, action_type, quantity, total_price, action_date, user_profile_name, reference_dest, note)

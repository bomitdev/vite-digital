...
try {
    ...
    $checkStmt = $pdo2->prepare("SELECT id FROM mt_materials WHERE code = :code AND id != :id");
    ...
    if ($id > 0) {
        ...
        $stmt = $pdo2->prepare("
            INSERT INTO mt_materials (code, name, type, unit, price_per_unit, min_alert, balance, image_path)

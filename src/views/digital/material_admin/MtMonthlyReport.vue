      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <h2 class="fw-bold text-dark mb-0">
            ...
            >รายงานวัสดุงานบริหารทั่วไปประจำเดือน (PDF)
          </h2>
        </div>
        <div>
  ...
  methods: {
    ...
    async fetchData() {
      ...
      try {
        ...
        const res = await axios.get(
          `/api-digital/material_admin/get_monthly_toner_summary.php?month=${month}&year=${year}`
        );
    ...
    async generatePDF() {
      ...
      try {
        ...
        doc.save(`monthly-admin-material-report-${dStr}.pdf`);
        Swal.close();
      } catch (err) {
        console.error(err);

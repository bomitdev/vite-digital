        ...
        <div class="card border-0 shadow-sm rounded-4 h-100">
          ...
          <div class="card-body p-4">
            <form @submit.prevent="saveGlobalSettings">
              ...
              <div class="text-end">
                <button type="submit" class="btn btn-success" :disabled="savingGlobal">
...
export default {
  ...
  methods: {
    ...
    async saveGlobalSettings() {
      ...
      try {
        const res = await axios.post('/api-digital/material_admin/save_global_settings.php', {
    ...
    async saveDeptForm() {
      ...
      try {
        const res = await axios.post(
          '/api-digital/material_admin/save_dept_signer.php',
          this.deptForm
        );
        if (res.data.success) {
          Swal.fire({
    ...
    async deleteDept(name) {
      ...
      if (confirm.isConfirmed) {
        try {
          const res = await axios.post('/api-digital/material_admin/delete_dept_signer.php', {

    ...
    >
      ...
      >
        ...
        <div class="d-flex gap-2 justify-content-end">
          ...
          <button class="btn btn-outline-secondary" @click="$router.push('/material-v2/requests')">
...
export default {
  ...
  methods: {
    ...
    async fetchRequest(id) {
      this.loading = true;
      try {
        const res = await axios.get(`/api-digital/material_v2/get_request_by_id.php?id=${id}`);
        if (res.data.success) {

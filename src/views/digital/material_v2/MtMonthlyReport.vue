        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-1">
              ...
              <li class="breadcrumb-item active" aria-current="page">รายงานประจำเดือน</li>
            </ol>
          </nav>
          <h2 class="fw-bold text-dark mb-0">
            <i class="bi bi-file-earmark-pdf me-2 text-danger"></i>รายงานหมึกประจำเดือน (PDF)
          </h2>
        </div>
      </div>
          ...
          <div class="card border-0 shadow-sm rounded-4 h-100 bg-white" style="min-height: 600px">
            ...
            >
              ...
              <p class="text-secondary" style="max-width: 400px">
                ...
                ตลับหมึกและดรัม ตามเดือนที่คุณเลือก คลิกปุ่ม
  ...
  methods: {
    ...
    async fetchData() {
      ...
      try {
        ...
        const res = await axios.get(
          `/api-digital/material_v2/get_monthly_toner_summary.php?month=${month}&year=${year}`
        );
    ...
    async generatePDF() {
      ...
      try {
        ...
        doc.setFont('Sarabun', 'normal');
        doc.text('กลุ่มงานสุขภาพดิจิทัล โรงพยาบาลชานุมาน อำเภอชานุมาน จังหวัดอำนาจเจริญ', 42, 40);
        ...
        // Date calculations
        const dStr = this.selectedMonth; // YYYY-MM
        const mom = moment(dStr, 'YYYY-MM');
        // Let's say the document date is the day it is exported
        ...
        doc.setFont('Sarabun', 'normal');
        doc.text(
          `ส่งรายงานการเงินประจำเดือน${thaiMonths[mom.month()]} ${mom.year() + 543}`,
          32,
          56
        );
        ...
        doc.setFont('Sarabun', 'normal');
        doc.text('หัวหน้ากลุ่มงานสุขภาพดิจิทัล', 32, 64);

        // Paragraph 1
        const p1Opts = { maxWidth: 160, align: 'justify', lineHeightFactor: 1.5 };
        const indentStr = '          ';
        doc.text(
          `${indentStr}กลุ่มงานสุขภาพดิจิทัลได้สรุปยอดการรับ-จ่าย ตลับหมึกและดรัม ประจำเดือน${
        ...
        doc.text('ตลับหมึกและดรัม', col1, listY);
        ...
        // Signature 1
        let signY = listY + 65;
        doc.text('(นายสริยา  จันทรา)', 140, signY, { align: 'center' });
        ...
        doc.line(125, signY + 1, 155, signY + 1);
        doc.text('นายแพทย์ชำนาญการ รักษาการในตำแหน่ง', 140, signY + 8, { align: 'center' });
        doc.text('ผู้อำนวยการโรงพยาบาลชานุมาน', 140, signY + 16, { align: 'center' });
        ...
        departments.forEach((d) => {
          ...
          head2.push({ content: d, styles: { halign: 'center', fontSize: 6.5 } });
        });
        ...
        autoTable(doc, {
          ...
          didDrawPage: (data) => {
            ...
            doc.setFont('Sarabun', 'bold');
            doc.text(
              `การใช้วัสดุคอมพิวเตอร์ ประจำเดือน ${thaiMonths[mom.month()]} ${mom.year() + 543}`,
              148,
              15,
              { align: 'center' }
            );
        ...
        // --- User ---
        doc.text(
          'ลงชื่อ..........................................................ผู้สรุปรายงาน /เจ้าหน้าที่พัสดุ',
          105,
          sumSignY,
          { align: 'center' }
        );
        ...
        doc.text('นายแพทย์ชำนาญการ รักษาการในตำแหน่ง', 105, sumSignY + 30, { align: 'center' });
        doc.text('ผู้อำนวยการโรงพยาบาลชานุมาน', 105, sumSignY + 38, { align: 'center' });

        doc.save(`monthly-toner-report-${dStr}.pdf`);
        Swal.close();
      } catch (err) {
        console.error(err);

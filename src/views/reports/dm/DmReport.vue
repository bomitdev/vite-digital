  ...
  <div class="container mt-4">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-2 d-flex align-items-end">
        <button @click="fetchDmPatients" class="btn btn-primary w-100">ดูข้อมูล</button>
      </div>
    </div>
...
export default {
  data() {
    return {
      startDate: '2024-10-01', // วันที่เริ่มต้น
      endDate: '2025-09-30', // วันที่สิ้นสุด
  ...
  methods: {
    async fetchDmPatients() {
      try {
        const response = await axios.get('/api-hosxe/get_dm_report1.php', {
          params: {

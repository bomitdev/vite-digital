  ...
  <div class="container py-4">
    ...
    <div v-if="data.length" class="results-section">
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <span class="badge bg-primary rounded-pill"> {{ data.length }} รายการ </span>
      </div>
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        <div v-for="item in data" :key="item.code">
          ...
          <div class="card h-100 procedure-card">
            ...
            <div class="card-body">
              <div class="mb-3">
                <h6 class="section-title"><i class="fas fa-language me-2"></i>Descriptions</h6>
              ...
              <div class="stats-section">
                <h6 class="section-title"><i class="fas fa-chart-bar me-2"></i>สถิติ</h6>
                <div class="row g-2">
                  <div class="col-6">
                    <div class="stat-card">
    ...
    async fetchData() {
      ...
      try {
        const response = await fetch(
          `/api-hosxe/dental/get_dental.php?start_date=${this.startDate}&end_date=${this.endDate}`
        );

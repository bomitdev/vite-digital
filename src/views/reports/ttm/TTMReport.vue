      ...
      <div class="card-body">
        ...
        <div class="text-center mb-3">
          <button
            ...
            @click="fetchData"
          >
            <span v-if="!loading"> <i class="fas fa-file-alt me-2"></i>ดูรายงาน </span>
            <span v-else>
            ...
            <div class="card-body">
              ...
              <div class="text-end">
                <small class="text-muted">
                  ...
                  {{ item.sum_price !== null ? formatNumber(item.sum_price) + ' บาท' : 'ไม่ระบุ' }}
                </small>
              </div>
            </div>
          </div>
    ...
    async fetchData() {
      ...
      try {
        const res = await fetch(
          `/api-hosxe/ttm/get_operation_ttm.php?start_date=${this.startDate}&end_date=${this.endDate}`
        );
